...
namespace DATABASE {
    ...
    public partial class hueDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(string ProductName, string Category, decimal Price, int Quantity, decimal Total, byte[] ProductImage) {
        ...
        public partial class ProductsRow : global::System.Data.DataRow {
            ...
            public decimal Total {
                get {
                    try {
                        return ((decimal)(this[this.tableProducts.TotalColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace DATABASE.hueDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Products] WHERE (([ProductId] = @Original_ProductId) AND ((@IsNull_ProductName = 1 AND [ProductName] IS NULL) OR ([ProductName] = @Original_ProductName)) AND ((@IsNull_Category = 1 AND [Category] IS NULL) OR ([Category] = @Original_Category)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Price] = @Original_Price)) AND ((@IsNull_Quantity = 1 AND [Quantity] IS NULL) OR ([Quantity] = @Original_Quantity)) AND ((@IsNull_Total = 1 AND [Total] IS NULL) OR ([Total] = @Original_Total)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Products] ([ProductName], [Category], [Price], [Quantity], [Total], [ProductImage]) VALUES (@ProductName, @Category, @Price, @Quantity, @Total, @ProductImage);
SELECT ProductId, ProductName, Category, Price, Quantity, Total, ProductImage FROM Products WHERE (ProductId = SCOPE_IDENTITY())";
...
SELECT ProductId, ProductName, Category, Price, Quantity, Total, ProductImage FROM Products WHERE (ProductId = @ProductId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DATABASE.Properties.Settings.Default.hueConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ProductId, ProductName, Category, Price, Quantity, Total, ProductImage FRO" +
                "M dbo.Products";
        ...
        public virtual int Delete(int Original_ProductId, string Original_ProductName, string Original_Category, global::System.Nullable<decimal> Original_Price, global::System.Nullable<int> Original_Quantity, global::System.Nullable<decimal> Original_Total) {
        ...
        public virtual int Insert(string ProductName, string Category, global::System.Nullable<decimal> Price, global::System.Nullable<int> Quantity, global::System.Nullable<decimal> Total, byte[] ProductImage) {
            if ((ProductName == null)) {
        ...
        public virtual int Update(string ProductName, string Category, global::System.Nullable<decimal> Price, global::System.Nullable<int> Quantity, global::System.Nullable<decimal> Total, byte[] ProductImage, int Original_ProductId, string Original_ProductName, string Original_Category, global::System.Nullable<decimal> Original_Price, global::System.Nullable<int> Original_Quantity, global::System.Nullable<decimal> Original_Total, int ProductId) {
            if ((ProductName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProductName, string Category, global::System.Nullable<decimal> Price, global::System.Nullable<int> Quantity, global::System.Nullable<decimal> Total, byte[] ProductImage, int Original_ProductId, string Original_ProductName, string Original_Category, global::System.Nullable<decimal> Original_Price, global::System.Nullable<int> Original_Quantity, global::System.Nullable<decimal> Original_Total) {
            return this.Update(ProductName, Category, Price, Quantity, Total, ProductImage, Original_ProductId, Original_ProductName, Original_Category, Original_Price, Original_Quantity, Original_Total, Original_ProductId);
        }
    }
